...
<body>
	<nav
		...
		<a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">八维网店</a> <input
			class="form-control form-control-dark w-100" type="text"
			placeholder="Search" aria-label="Search">
		<ul class="navbar-nav px-3">
			<li class="nav-item text-nowrap"><a class="nav-link" href="#">查询</a>
			</li>
		</ul>
	</nav>
			...
			<nav class="col-md-2 d-none d-md-block bg-light sidebar">
				<div class="sidebar-sticky">
					<ul class="nav flex-column">
						<li class="nav-item"><a class="nav-link" href="#" data-toggle="/brand/list">
						...
						<li class="nav-item"><a class="nav-link" href="#" data-toggle="/cat/list"> <svg
									xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									viewBox="0 0 24 24" fill="none" stroke="currentColor"
									stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
						...
						<li class="nav-item"><a class="nav-link" href="#" data-toggle="/goods/list"> <svg
									xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									viewBox="0 0 24 24" fill="none" stroke="currentColor"
									stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
						...
						<li class="nav-item"><a class="nav-link" href="#" data-toggle="/goods/skulist"> <svg
									xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									viewBox="0 0 24 24" fill="none" stroke="currentColor"
									stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
...
<script type="text/javascript">
	$(".nav-link").click(function(){
		var relUrl= $(this).attr('data-toggle');
		console.log("准备进入"+relUrl);
		$("#main").load(relUrl);
